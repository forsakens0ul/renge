...
import { AlertTriangle, Clock, Shield, Phone, BookOpen, Download, ArrowLeft, CheckCircle, Brain, Users, Heart, AlertCircle } from 'lucide-react';

// 专业80题测试数据 - 基于DSM-5标准
const testData = {
  "version": "2.0",
  "title": "人格障碍倾向专业筛查量表",
  "description": "基于DSM-5诊断标准的80题专业评估工具",
  "total_questions": 80,
  "dimensions": {
    "paranoid": {
      "name": "偏执型人格特质",
  ...
  "high_risk_questions": [36, 37], // BPD自伤相关题目索引
  "questions": [
    // 偏执型人格特质 (PPD) - 8题
    "我经常怀疑他人对我有恶意或想要伤害我",
...
function App() {
  const [currentPage, setCurrentPage] = useState('intro'); // 'intro', 'test', 'results'
  const [currentQuestion, setCurrentQuestion] = useState(0);
  const [answers, setAnswers] = useState<number[]>(new Array(testData.total_questions).fill(0));
    ...
    if (currentPage === 'test') {
      ...
      const timeout = setTimeout(() => {
        if (answers[currentQuestion] === 0) {
          alert('💡 专业建议：请根据第一直觉选择，过度思考可能影响结果准确性');
        }
      }, 120000); // 2分钟提醒
  ...
  const getDetailedInterpretation = (dimensionKey: string, score: number, threshold: number) => {
    ...
    return interpretations[dimensionKey]?.[level] || "需要专业评估以获得更准确的解释。";
  };
      ...
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
        <div className="text-center">
          ...
          <p className="text-gray-700 mb-6">
            您提到曾有自伤行为或相关想法。如果您目前正在经历困扰，建议立即联系专业帮助：
          </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-8 mb-10 rounded-r-xl">
              <div className="flex items-start">
                <AlertTriangle className="text-red-500 mr-4 mt-1 flex-shrink-0" size={28} />
                <div>
                  <h3 className="text-xl font-bold text-red-800 mb-3">📢 重要免责声明</h3>
                  <div className="text-red-700 space-y-2">
                    <p className="font-semibold">本测试仅用于评估人格特质倾向，<span className="underline">绝不能替代专业诊断</span>。</p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              <div className="bg-blue-50 p-6 rounded-2xl border border-blue-200">
                ...
                <div className="text-blue-700 space-y-2">
                  <p><span className="font-semibold">题目数量：</span>80题</p>
                  <p><span className="font-semibold">预计时长：</span>25-35分钟</p>
                  <p><span className="font-semibold">评估维度：</span>10种人格特质</p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 py-6 max-w-4xl">
          <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="w-24"></div> {/* 占位符保持布局平衡 */}
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-10">
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-4">专业筛查报告</h1>
                ...
                <div>
                  ...
                  <div className="text-red-700 space-y-3">
                    ...
                    <p className="bg-red-100 p-4 rounded-lg">
                      ...
                      请尽快咨询精神科医生或注册临床心理师进行专业评估。
                      本筛查结果不能替代专业诊断，但可作为寻求专业帮助的重要参考。
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-10">
            ...
            <div className="bg-green-50 p-6 rounded-2xl text-center border border-green-200">
              ...
              <h4 className="font-bold text-green-800 mb-3">专业资源库</h4>
            ...
            <div className="bg-purple-50 p-6 rounded-2xl text-center border border-purple-200">
              ...
              <p className="text-purple-600 text-sm mb-3">生成详细PDF报告</p>
              <button className="text-purple-600 hover:text-purple-700 text-sm underline font-semibold">
                下载完整报告
              </button>
            </div>

            <div className="bg-orange-50 p-6 rounded-2xl text-center border border-orange-200">
              <Users className="text-orange-600 mx-auto mb-4" size={36} />
              <h4 className="font-bold text-orange-800 mb-3">寻找专业帮助</h4>
              <p className="text-orange-600 text-sm mb-3">精神科医生与心理师</p>
              <button className="text-orange-600 hover:text-orange-700 text-sm underline font-semibold">
                查找专业人士
              </button>
            </div>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                分享给专业人士
              </button>
            </div>
          </div>
